...
class restaurant_Detail_Page extends StatefulWidget {
  const restaurant_Detail_Page({Key? key, required this.food})
      : super(key: key);
  final Restaurant_Food food;

  @override
  State<restaurant_Detail_Page> createState() => _DetailPageState();
}

class _DetailPageState extends State<restaurant_Detail_Page> {
  int quantity = 1;
  @override
