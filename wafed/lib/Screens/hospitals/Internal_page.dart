...
import 'package:wafed/Screens/hospitals/i_doctors.dart';
import 'package:wafed/Screens/restaurant/restaurant_Detail_Page.dart';

import 'dentistry_detail.dart';
import 'i_doctors.dart';
import 'Internal_detail.dart';

class genetics_page extends StatefulWidget {
  @override
  State<genetics_page> createState() => _genetics_page();
}

class _genetics_page extends State<genetics_page> {
  int indexCategory = 0;
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          dctors.getLocalizedName(context),
