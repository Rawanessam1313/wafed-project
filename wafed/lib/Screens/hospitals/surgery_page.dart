...
import 's_doctors.dart';
import 'surgery_detail.dart';

class surgery_page extends StatefulWidget {
  @override
  State<surgery_page> createState() => _surgery_page();
}

class _surgery_page extends State<surgery_page> {
  int indexCategory = 0;
