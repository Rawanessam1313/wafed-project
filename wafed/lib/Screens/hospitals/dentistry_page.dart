...
class dentistry_page extends StatefulWidget {
  @override
  State<dentistry_page> createState() => _dentistry_page();
}

class _dentistry_page extends State<dentistry_page> {
  int indexCategory = 0;
  ...
  Widget griddentistry() {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        d_doctors dctors = d[index];
        return GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) {
                return dentistry_detail(
                  dctors: dctors,
                );
              }));
            },
