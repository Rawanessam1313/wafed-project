...
class Internal_detail extends StatefulWidget {
  const Internal_detail({Key? key, required this.dctors}) : super(key: key);
  final i_doctors dctors;

  @override
  State<Internal_detail> createState() => _DetailPageState();
}

class _DetailPageState extends State<Internal_detail> {
  int quantity = 1;
  @override
