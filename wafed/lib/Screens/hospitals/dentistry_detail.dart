...
class dentistry_detail extends StatefulWidget {
  const dentistry_detail({Key? key, required this.dctors}) : super(key: key);
  final d_doctors dctors;

  @override
  State<dentistry_detail> createState() => _DetailPageState();
}

class _DetailPageState extends State<dentistry_detail> {
  int quantity = 1;
  @override
