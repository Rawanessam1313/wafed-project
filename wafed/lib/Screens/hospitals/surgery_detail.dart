...
class surgery_detail extends StatefulWidget {
  const surgery_detail({Key? key, required this.dctors}) : super(key: key);
  final s_doctors dctors;

  @override
  State<surgery_detail> createState() => _DetailPageState();
}

class _DetailPageState extends State<surgery_detail> {
  int quantity = 1;
  @override
