...
import 'Gomhoria_Sporting _Club_page.dart';

class Menoufia_CityClubs_page extends StatelessWidget {
  final List<Map<String, String>> dataArr1 = [
    {
      "image": "assets/images/entertainement/city.jpeg",
      "route": "",
    },
  ];
  final List<Map<String, String>> dataArr = [
    {
      "image": "assets/images/entertainement/club1.png",

      "route": "", // Add route for each image
    },
    {
      "image": "assets/images/entertainement/club2.png",

      "route": "", // Add route for each image
    },
    {
      "image": "assets/images/entertainement/club3.png",
      "route": "",
    },
    {
      "image": "assets/images/entertainement/club4.png",
      "route": "",
    },
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Center(
                        child: Text(
                          TKeys.City_Club.translate(context),
                          style: TextStyle(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            _launchWebsite(
                                "https://cityclubeg.com/"); // Replace with your website URL
                          },
